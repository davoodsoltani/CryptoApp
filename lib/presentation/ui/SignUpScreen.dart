                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text('Sign Up',style: GoogleFonts.ubuntu(fontSize: height * 0.035,color: Colors.white,fontWeight: FontWeight.bold)),
                        ),
                        const SizedBox(height: 10,),
                        Padding(
                          padding: const EdgeInsets.only(left: 20.0),
                          child: Text('Create Account',style: GoogleFonts.ubuntu(fontSize: height * 0.03,color: Colors.white)),
                        ),
